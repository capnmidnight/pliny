  ...
  if (obj) {
    ...
    if (typeof obj === "function") {
      ...
      while (!!(match = scriptPattern.exec(script))) {
        ...
        pliny$1[fieldType].call(null, fieldInfo);
      }
    }
  }
  return obj;
...
window.pliny = pliny$1;
window.formats = formats;

fetch("./testRecording.doc.js")
  .then(res => res.text())
  .then(eval)
  .then(() => document.body.innerHTML = formats.html(pliny$1.database, "Hello.World"));
